...
ServerEvents.recipes(e => {
  ...
  e.remove([
    { id: "embers:dawnstone_anvil/tool_materia_repair" },
    { id: "embers:dawnstone_anvil/tool_repair" },
    { id: /embers:stamping\/nuggets\// },
    { id: /embers:stamping\/gears\// },
    { id: /embers:stamping\/ingots\// }
  ]);
  //#endregion
  ...
  //#endregion
  //#region - Aspectus
  e.remove({ id: /embers:stamping\/.*_aspectus/ });
  e.custom({
    type: "embers:alchemy",
    output: {
      item: "kubejs:inert_aspectus"
    },
    tablet: {
      item: "embers:ember_crystal"
    }
  });
  let potting_aspectus = (Material, Result) => {
    e.custom({
      type: "embers:stamping",
      fluid: {
        amount: 1440,
      ...
      input: { item: "kubejs:inert_aspectus" },
      output: { item: Result },
      stamp: { item: "kubejs:aspectus_stamp" }
    });
  };
  // Embers
  potting_aspectus("forge:molten_copper", "embers:copper_aspectus");
  potting_aspectus("forge:molten_dawnstone", "embers:dawnstone_aspectus");
  potting_aspectus("forge:molten_iron", "embers:iron_aspectus");
  potting_aspectus("forge:molten_lead", "embers:lead_aspectus");
  potting_aspectus("forge:molten_silver", "embers:silver_aspectus");
  //#endregion
  //#region - Melting
  ...
  //#endregion
  //#region - Aspectus Stamp
  e.shaped("kubejs:raw_aspectus_stamp", ["A A", " A ", "A A"], {
    A: "embers:caminite_blend"
  });
  e.custom({
    ...
    cookingtime: 200,
    experience: 0.1,
    ingredient: { item: "kubejs:raw_aspectus_stamp" },
    result: "kubejs:aspectus_stamp"
  });
  //#endregion
});
//#endregion
