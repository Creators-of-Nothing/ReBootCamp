...
ServerEvents.recipes(e => {
  ...
  // Powah
  potting_ore_vein_type("forge:is_overworld", "powah:uraninite_ore", "Excavated Uraninite");
  // Botania
  ...
  // Mana and Artifice
  potting_ore_vein_type("forge:is_overworld", "mna:vinteum_ore", "Excavated Vinteum");
  // Malum
  ...
  potting_drilling("mna:vinteum_ore", "mob_grinding_utils:fluid_xp", "createoreexcavation:kjs/3r1vi5z494ipjickbxkwx9rml");
