...
ServerEvents.recipes(e => {
  ...
  const listOfRaws = [
    ...
    "kubejs:raw_ender",
    "kubejs:raw_etherium",
    "kubejs:raw_blazing_quartz",
    "kubejs:raw_brilliant"
  ];
  const listOfClumps = [
    "kubejs:clump_coal",
    "kubejs:clump_iron",
    ...
    "kubejs:clump_desh",
    "kubejs:clump_ostrum",
    "kubejs:clump_calorite",
    "kubejs:clump_zinc",
    "kubejs:clump_lead",
    "kubejs:clump_silver",
    "kubejs:clump_elementium",
    "kubejs:clump_dragonstone",
    "kubejs:clump_vinteum",
    "kubejs:clump_soulstone",
    "kubejs:clump_amber",
    "kubejs:clump_thallasium",
    "kubejs:clump_ender",
    "kubejs:clump_etherium",
    "kubejs:clump_blazing_quartz",
    "kubejs:clump_brilliant"
  ];
  const listOfShards = [
    "kubejs:shard_coal",
    "kubejs:shard_iron",
    ...
    "kubejs:shard_desh",
    "kubejs:shard_ostrum",
    "kubejs:shard_calorite",
    "kubejs:shard_zinc",
    "kubejs:shard_lead",
    "kubejs:shard_silver",
    "kubejs:shard_elementium",
    "kubejs:shard_dragonstone",
    "kubejs:shard_vinteum",
    "kubejs:shard_soulstone",
    "kubejs:shard_amber",
    "kubejs:shard_thallasium",
    "kubejs:shard_ender",
    "kubejs:shard_etherium",
    "kubejs:shard_blazing_quartz",
    "kubejs:shard_brilliant"
  ];
  const listOfCrystals = [
    "kubejs:crystal_coal",
    "kubejs:crystal_iron",
    "kubejs:crystal_copper",
    "kubejs:crystal_gold",
    "kubejs:crystal_redstone",
    ...
    "kubejs:crystal_desh",
    "kubejs:crystal_ostrum",
    "kubejs:crystal_calorite",
    "kubejs:crystal_zinc",
    "kubejs:crystal_lead",
    "kubejs:crystal_silver",
    "kubejs:crystal_elementium",
    "kubejs:crystal_dragonstone",
    "kubejs:crystal_vinteum",
    "kubejs:crystal_soulstone",
    "kubejs:crystal_amber",
    "kubejs:crystal_thallasium",
    "kubejs:crystal_ender",
    "kubejs:crystal_etherium",
    "kubejs:crystal_blazing_quartz",
    "kubejs:crystal_brilliant"
  ];
  const listOfFinalElements = [
    "minecraft:coal",
...
ServerEvents.blockLootTables(e => {
  ...
  //#region - Potting
  potting_ore_drop(
    ["minecraft:coal_ore", "minecraft:deepslate_coal_ore", "ad_astra:venus_coal_ore", "ad_astra:glacio_coal_ore", "alexscaves:coprolith_coal_ore"],
    "minecraft:coal_ore",
    "kubejs:raw_coal"
  );
  potting_ore_drop(
    ["minecraft:iron_ore", "minecraft:deepslate_iron_ore", "ad_astra:moon_iron_ore", "ad_astra:mars_iron_ore", "ad_astra:mercury_iron_ore", "ad_astra:glacio_iron_ore", "alexscaves:galena_iron_ore"],
    "minecraft:iron_ore",
    "minecraft:raw_iron"
  );
  ...
  potting_ore_drop("mna:vinteum_ore", "mna:vinteum_ore", "mna:raw_vinteum");
