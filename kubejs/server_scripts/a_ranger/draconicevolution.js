...
function draconicevolution() {
  ...
  let unused = ["draconicevolution:stabilized_spawner", "draconicevolution:disenchanter", "draconicevolution:generator", /draconicevolution:.*_draconium_ore/, /draconicevolution:.*draconium_dust/, "draconicevolution:infused_obsidian", "draconicevolution:info_tablet", /draconicevolution:reactor_/, "draconicevolution:draconium_chest", "draconicevolution:grinder"];
