...
function mob_grinding_utils() {
  ...
  let unused = ["mob_grinding_utils:spikes", "mob_grinding_utils:entity_spawner", "mob_grinding_utils:solid_xp_mould_blank", "mob_grinding_utils:dark_oak_stone", "mob_grinding_utils:xpsolidifier", "mob_grinding_utils:solid_xp_block", "mob_grinding_utils:solid_xp_mould_baby", "mob_grinding_utils:solid_xp_baby", "mob_grinding_utils:xp_solidifier_upgrade", "mob_grinding_utils:spawner_upgrade_height", "mob_grinding_utils:spawner_upgrade_width", "mob_grinding_utils:nutritious_chicken_feed", "mob_grinding_utils:gm_chicken_feed", "mob_grinding_utils:gm_chicken_feed_cursed", "mob_grinding_utils:rotten_egg", "mob_grinding_utils:golden_egg"];
  let hiding = ["mob_grinding_utils:ender_inhibitor_off", "mob_grinding_utils:mob_swab_used"];
